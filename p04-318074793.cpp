...
int main()
{
	...
	CrearCono(27, 2.0f);//índice 3 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Grúa
		{
			...
			color = glm::vec3(0.0f, 0.35f, 0.47f);
			...
			//Base
			{
				...
				//ruedas atras derecha
				color = glm::vec3(0.0f, 0.0f, 0.0f);
				model = glm::translate(model, glm::vec3(2.0f, -1.0f, -2.3f));
			...
			color = glm::vec3(60.0f, 0.0f, 25.0f);
			glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			sp.render();
			model = modelaux;
			...
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			color = glm::vec3(255.0f, 165.0f, 0.0f);
			glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
			...
			//articulación 4
			model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
			model = glm::rotate(model, glm::radians(305.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//Animal
		{
			...
			////AQUÍ SE DIBUJA LA CABINA, LA BASE, LAS 4 LLANTAS
			//BASE PRINCIPAL
			model = glm::translate(model, glm::vec3(20.0f, 0.0f, -4.0f));
			...
			//Pata1
			{
				...
				color = glm::vec3(0.8f, 0.5f, 0.3f);
				glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
				meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangul
				model = modelaux2;
				...
				model = glm::translate(model, glm::vec3(-0.2f, -1.8f, 0.0f));
			...
			//cabeza
			{
				...
				//articulación 1
				model = glm::translate(model, glm::vec3(-1.3f, 0.9f, 0.0f));
				...
				//OJOS
				model = modelaux2;
				model = glm::translate(model, glm::vec3(-1.0f, 0.4f, -0.4f));
				...
				//Orejas oreja derecha

				model = modelaux2;
				model = glm::translate(model, glm::vec3(0.0f, 1.0f, 0.4f));
				model = glm::scale(model, glm::vec3(1.0f, 2.0f, 0.3f));
